 ...
 * @param int $height
 */
function resize($width, $height, $path, $fieldnm, $randname){
  /* Get original image x y*/
  list($w, $h) = getimagesize($_FILES[$fieldnm]['tmp_name']);
  ...
  $imgString = file_get_contents($_FILES[$fieldnm]['tmp_name']);
